...
const u8 gTypeEffectiveness[NUMBER_OF_TYPE_INTERACTIONS] =
{
    ...
    TYPE_DRAGON, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
...
//TODO: Decapitalize
/**
 * Contains the name of all the types in the game. 
 * Might need to be decapitalized.
 */
...
#define NUMBER_OF_STATUS_CONDITION_STRINGS 7
...
const u8 *const gStatusConditionStringsTable[NUMBER_OF_STATUS_CONDITION_STRINGS][NUMBER_OF_LANGUAGES] =
{
